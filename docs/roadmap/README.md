...
|---|---|---|---|
| **Eventos** (`ml.on('request' \| 'response' \| 'retry' \| 'tokenRefreshed' \| 'rateLimit' \| 'error')`) | Média | 2 dias | ⏳ Planejado |
...
| **MockTransport** para testes (testar sem chamar ML) | Baixa | 1 dia | ⏳ Planejado |
